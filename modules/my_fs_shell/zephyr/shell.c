...
#if defined(CONFIG_MY_FILE_SYSTEM_SHELL_ENABLE_MOUNT)
...
#if defined(CONFIG_MY_FILE_SYSTEM_SHELL_ENABLE_MOUNT) && defined(CONFIG_FAT_FILESYSTEM_ELM)
...
#if defined(CONFIG_MY_FILE_SYSTEM_SHELL_ENABLE_MOUNT) && defined(CONFIG_FILE_SYSTEM_LITTLEFS)
...
#if defined(CONFIG_MY_FILE_SYSTEM_SHELL_ENABLE_MOUNT)
    SHELL_CMD(mount, &sub_fs_mount, "<Mount fs, syntax:- fs mount <fs type> <mount-point>", NULL),
#endif
